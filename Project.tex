...
\begin{figure}[H]
	...
	\end{minipage}
\end{figure}
And we can do the same operation in a combination of two signal: $cos(2\pi \dot 3t)+cos(2\pi \dot 5t)$. Then we can get similar result: two peaks at 3 and 5 Hz. 
\begin{figure}[H]
